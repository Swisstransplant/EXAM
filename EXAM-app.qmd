...
## What is EXAM?
EXAM (ex vivo allograft monitoring) is an analytics dashboard for hypothermic machine perfusion data in deceased-donor kidney transplantation. It supports data from the ORS LifePort Kidney Transporter.

## How was KIDMO developed?
EXAM was developed by [Swisstransplant](https://www.swisstransplant.org/)---the *Swiss National Foundation for organ donation and transplantation* and the transplant centers. Further information can be found in the reference below.
